...
def build_shop_kb() -> InlineKeyboardMarkup:
    ...
    builder.button(
        text="My address", callback_data=ShopCbData(actions=ShopActions.address).pack()
    )
    builder.adjust(1)
...
def product_details_kb(product_cb_data: ProductCbData) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.button(
...
def build_update_product_kb(product_cb_data: ProductCbData) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.button(
